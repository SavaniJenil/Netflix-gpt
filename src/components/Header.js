...
const Header = () => {
  ...
  return (
    <div className="absolute bg-gradient-to-b from-black z-[2]  w-full flex justify-between items-center">
      <img className="w-60" src={LOGO_URL} alt="app-logo" />
      {userInfo && (
        <div className="flex flex-row items-center cursor-pointer">
          ...
          {showGptSearch ? (
            <button className="text-white font-medium px-1" onClick={handleGPTSearchClick}>
              Home
            </button>
          ) : (
            <div
            className="gpt flex flex-row px-3"
          ...
          >
            ...
            <p className="text-white font-medium px-1">GPT</p>
          </div>
          )}
